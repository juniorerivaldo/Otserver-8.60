...
shopModule:addSellableItem({'arrow'}, 2544, 15, 1, 'arrow')
shopModule:addSellableItem({'assassin star'}, 7368, 250, 1, 'assassin star')
shopModule:addSellableItem({'bolt'}, 2543, 25, 1, 'bolt')
shopModule:addSellableItem({'bow'}, 2456, 400, 1, 'bow')
shopModule:addSellableItem({'crossbow'}, 2455, 700, 1, 'crossbow')
shopModule:addSellableItem({'spear'}, 2389, 25, 1, 'spear')
shopModule:addSellableItem({'royal spear'}, 7378, 150, 1, 'royal spear')
shopModule:addSellableItem({'earth arrow'}, 7850, 85, 1, 'earth arrow')
shopModule:addSellableItem({'flaming arrow'}, 7840, 85, 1, 'flaming arrow')
shopModule:addSellableItem({'flash arrow'}, 7838, 85, 1, 'flash arrow')
shopModule:addSellableItem({'onyx arrow'}, 7365, 85, 1, 'onyx arrow')
shopModule:addSellableItem({'piercing bolt'}, 7363, 85, 1, 'piercing bolt')
shopModule:addSellableItem({'power bolt'}, 2547, 85, 1, 'power bolt')
shopModule:addSellableItem({'shiver arrow'}, 7839, 85, 1, 'shiver arrow')
shopModule:addSellableItem({'sniper arrow'}, 7364, 85, 1, 'sniper arrow')
shopModule:addSellableItem({'throwing knife'}, 2410, 105, 1, 'throwing knife')
shopModule:addSellableItem({'throwing star'}, 2399, 105, 1, 'throwning star')
