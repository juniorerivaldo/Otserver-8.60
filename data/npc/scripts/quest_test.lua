...
local function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, "cough syrup") then
        npcHandler:say(
            "Do you want to buy a bottle of cough syrup for 50 gold?", cid)
        npcHandler.topic[cid] = 1
    elseif msgcontains(msg, 'mission') then
        if player:getStorageValue(PlayerStorageKeys.TibiaTales.TheExterminator) ==
            -1 then
            npcHandler:say({
        ...
        elseif player:getStorageValue(PlayerStorageKeys.TibiaTales
            ...
            npcHandler:say(
                'Maybe the guards have something to do for you or know someone who could need some help.',
                cid)
        end
