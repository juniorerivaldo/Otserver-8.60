...
shopModule:addBuyableItem({'energy ring'}, 2167, 5000, 1, 'energy ring')
shopModule:addBuyableItem({'life ring'}, 2168, 5000, 1, 'life ring')
shopModule:addBuyableItem({'dwarven ring'}, 2213, 5000, 1, 'dwarven ring')
